...
--From the following table, write a SQL query to find details of 
--all orders with a purchase amount less than 200 or exclude 
...
--From the following table, write a SQL query to find all orders 
--that meet the following conditions. Exclude combinations of 
--order date equal to '2012-08-17' or customer ID greater than 
...
--From the following table, write a SQL query to find the details 
--of all employees whose last name is ‘Dosni’ or ‘Mardy’. Return 
--emp_idno, emp_fname, emp_lname, and emp_dept. 
...
--employees who work at depart 47 or 63. Return emp_idno, 
